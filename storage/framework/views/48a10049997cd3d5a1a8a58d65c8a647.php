...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border">
            <form method="GET" action="<?php echo e(route('skoring_penghargaan.index')); ?>">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $penilaian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    <?php echo e($loop->iteration + ($penilaian->currentPage() - 1) * $penilaian->perPage()); ?>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                        <?php echo e($item->aspek_penilaian->uraian ?? '-'); ?>  
                                </td>
                                <td class="px-6 py-4 text-sm"> 
                                        <?php echo e($item->aspek_penilaian->indikator_poin ?? 0); ?>
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <div class="flex gap-2">
                                        <button
                                            onclick="openDeleteModalPenghargaan('<?php echo e($item->id_penilaian); ?>', '<?php echo e($item->siswa->nama_siswa); ?>')"
...
<div id="modal-filter" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 relative overflow-visible">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-2xl">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-xl font-semibold text-gray-800">Filter Data Penghargaan</h3>
            </div>
            ...
            <div class="p-6 space-y-6">
             ...
             <?php endif; ?>
                ...
                <div class="space-y-2">
                    ...
                    <select name="jenis_penghargaan" class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all">
                        ...
                        <?php $__currentLoopData = $aspekPel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aspek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($aspek->id_aspekpenilaian); ?>" <?php echo e(request('jenis_penghargaan') == $aspek->id_aspekpenilaian ? 'selected' : ''); ?>>
    ...
    <?php echo $__env->make('wakasek.skoring.penghargaan.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('wakasek.skoring.penghargaan.delete', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.wakasek.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/skoring/penghargaan/index.blade.php ENDPATH**/ ?>