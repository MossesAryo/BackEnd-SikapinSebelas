<!-- Modal Create -->
    <div id="modal-create" class="fixed inset-0 bg-black bg-opacity-40 modal-overlay flex items-center justify-center hidden">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
            <form action="<?php echo e(route('siswa.store')); ?>" method="POST" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="nis" name="nis" required placeholder="Contoh : 2367980756"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    <div>
                        <label for="nama_siswa" class="block text-sm font-medium text-gray-700 mb-1">Nama Siswa</label>
                        <input type="text" id="nama_siswa" name="nama_siswa" required placeholder="Contoh : Budi Santoso"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    <div>
                        ...
                        <select id="id_kelas" name="id_kelas" required
                            ...
                            <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    </div><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/siswa/create.blade.php ENDPATH**/ ?>