<div id="modal-create-penghargaan" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center hidden z-[999999]">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xl mx-4 my-8 overflow-hidden">
        <form action="<?php echo e(route('siswa.skoringPenghargaan', ['nis' => $siswa->nis])); ?>" method="POST" class="p-6 space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <select id="aspek_penghargaan" name="id_aspekpenilaian" required
                        ...
                        <?php $__currentLoopData = $skoringpenghargaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/siswa/create-penghargaan.blade.php ENDPATH**/ ?>