            ...
            <div class="mt-4">
                ...
                <div id="exportContent" class="tab-content">
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='<?php echo e(route('ketua_program.export.excel')); ?>'"
                        ...
                        <button onclick="window.location='<?php echo e(route('ketua_program.export.pdf')); ?>'"
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" action="<?php echo e(route('ketua_program.import')); ?>" method="POST"
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div id="dropZoneKaprog"
                                    ...
                                    <input type="file" name="file" id="importFileKaprog" class="hidden"
                                        accept=".xlsx,.xls,.csv">
                            ...
                            <div class="pt-3 border-t">
                                <a href="<?php echo e(asset('storage/template_kaprog.xlsx')); ?>" download
...
<script>
    ...
    // Drag and Drop
    const dropZoneKaprog = document.getElementById('dropZoneKaprog');
    const importFileKaprog = document.getElementById('importFileKaprog');

    // Klik seluruh area
    dropZoneKaprog.addEventListener('click', () => {
        importFileKaprog.click();
    });

    // Drag over
    dropZoneKaprog.addEventListener('dragover', (e) => {
        e.preventDefault();
        dropZoneKaprog.classList.add('border-blue-400', 'bg-blue-50');
    });

    // Drag leave
    dropZoneKaprog.addEventListener('dragleave', () => {
        dropZoneKaprog.classList.remove('border-blue-400', 'bg-blue-50');
    });

    // Drop file
    dropZoneKaprog.addEventListener('drop', (e) => {
        e.preventDefault();
        dropZoneKaprog.classList.remove('border-blue-400', 'bg-blue-50');

        const files = e.dataTransfer.files;
        if (files.length) {
            importFileKaprog.files = files;
            handleFileSelect(importFileKaprog);
        }
    });

    // File picker
    importFileKaprog.addEventListener('change', () => {
        handleFileSelect(importFileKaprog);
    });
</script>
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/kaprog/modalExportImport.blade.php ENDPATH**/ ?>