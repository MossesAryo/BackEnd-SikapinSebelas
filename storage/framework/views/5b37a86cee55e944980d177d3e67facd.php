<div id="modal-filter"
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300 scale-95 " 
        ...
        <!-- Form -->
        <form method="GET" action="<?php echo e(route('aspek_penghargaan.index')); ?>"
              class="p-6 space-y-6">
...
function resetForm() {
    ...
    window.location.href = "<?php echo e(route('aspek_penghargaan.index')); ?>";
}
</script><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/aspek_penilaian/aspek_penghargaan/filter.blade.php ENDPATH**/ ?>