<div id="exportImportModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-[9999]">
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <!-- Modal Header -->
            <div class="flex items-center justify-between pb-3 border-b">
                <h3 class="text-lg font-medium text-gray-900">Export/Import Data Walikelas </h3>
            ...
            <div class="mt-4">
                ...
                <div id="exportContent" class="tab-content">
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='<?php echo e(route('walikelas.export.excel')); ?>'"
                        ...
                        <button onclick="window.location='<?php echo e(route('walikelas.export.pdf')); ?>'"
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" action="<?php echo e(route('walikelas.import')); ?>" method="POST"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-3 border-t">
                                <a href="<?php echo e(asset('storage/template_walikelas.xlsx')); ?>" download
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/walikelas/modalExportImport.blade.php ENDPATH**/ ?>