    ...
    <div id="modal-create" class="fixed inset-0 bg-black bg-opacity-40 z-50 flex items-center justify-center hidden">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
            <form action="<?php echo e(route('gurubk.store')); ?>" method="POST" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-2">
                    <div>
                        ...
                        <input type="text" id="nip" name="nip_bk" placeholder=" Contoh : 1908756382"
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/guru_bk/create.blade.php ENDPATH**/ ?>