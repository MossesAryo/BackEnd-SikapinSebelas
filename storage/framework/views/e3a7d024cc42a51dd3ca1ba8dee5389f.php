<div id="modal-create" class="fixed inset-0 bg-black bg-opacity-40 modal-overlay flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
        <form action="<?php echo e(route('skoring_pelanggaran.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/skoring/pelanggaran/create.blade.php ENDPATH**/ ?>