        ...
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border">
                <div class="flex flex-col md:flex-row gap-2 items-center justify-between">
                    <div class="relative w-full md:w-64">
                        ...
                        <input id="inputSearch" type="text" placeholder="Cari Pelanggaran..."
            ...
            <div class="bg-white rounded-xl shadow-sm border overflow-visible">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody id="tableBody" class="bg-white divide-y divide-gray-100">
                            <?php $__empty_1 = true; $__currentLoopData = $aspek_penilaian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 group">

                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-gray-900">
                                            <?php echo e(($aspek_penilaian->firstItem() ?? 0) + $loop->iteration - 1); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($item->kategori); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($item->uraian); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-semibold text-gray-900"><?php echo e($item->pelanggaran_ke); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm font-semibold text-gray-900"><?php echo e($item->indikator_poin); ?></span>
                                    </td>
                                    <?php if(auth()->user()->role == 1): ?>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center gap-1">
                                                <button
                                                    onclick="openEditModal('<?php echo e($item->id_aspekpenilaian); ?>','<?php echo e($item->jenis_poin); ?>', '<?php echo e($item->kategori); ?>', '<?php echo e($item->uraian); ?>', '<?php echo e($item->pelanggaran_ke); ?>', '<?php echo e($item->indikator_poin); ?>')"
                                                ...
                                                <button onclick="openDeleteModal('<?php echo e($item->id_aspekpenilaian); ?>')"
                ...
                <div id="pagination" class="px-6 py-4 border-t border-gray-200 bg-white">
                    <?php echo $__env->make('layouts.wakasek.pagination', ['data' => $aspek_penilaian], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>

        <?php echo $__env->make('wakasek.aspek_penilaian.aspek_pelanggaran.modalExportImport', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('wakasek.aspek_penilaian.aspek_pelanggaran.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('wakasek.aspek_penilaian.aspek_pelanggaran.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('wakasek.aspek_penilaian.aspek_pelanggaran.delete', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('wakasek.aspek_penilaian.aspek_pelanggaran.filter', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.wakasek.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/aspek_penilaian/aspek_pelanggaran/index.blade.php ENDPATH**/ ?>