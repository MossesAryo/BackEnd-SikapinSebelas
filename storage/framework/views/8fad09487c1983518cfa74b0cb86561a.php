...
<div id="modal-peringatan" class="hidden">
    <div class="modal-box bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
        ...
        <form action="<?php echo e(route('siswa.peringatan', ['nis' => $siswa->nis])); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <select id="id_sp" name="id_sp" required
                        ...
                        <?php $__currentLoopData = $peringatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id_sp); ?>"><?php echo e($item->level_sp); ?></option>
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/siswa/peringatan.blade.php ENDPATH**/ ?>