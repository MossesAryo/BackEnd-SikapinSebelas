    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="flex items-center justify-between pb-3 border-b">
                <h3 class="text-lg font-medium text-gray-900">Export/Import Data Guru Bk </h3>
            ...
            <div class="mt-4">
                ...
                <div id="exportContent" class="tab-content">
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='<?php echo e(route('guru_bk.export.excel')); ?>'"
                        ...
                        <button onclick="window.location='<?php echo e(route('guru_bk.export.pdf')); ?>'"
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" action="<?php echo e(route('guru_bk.import')); ?>" method="POST"
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div id="dropZoneBk"
                                    ...
                                    <input type="file" name="file" id="importFileBk" class="hidden"
                                        accept=".xlsx,.xls,.csv">
                            ...
                            <div class="pt-3 border-t">
                                <a href="<?php echo e(asset('storage/template_gurubk.xlsx')); ?>" download
...
<script>
    ...
    // Drag and Drop
    const dropZoneBk = document.getElementById('dropZoneBk');
    const importFileBk = document.getElementById('importFileBk');

    // Klik seluruh area
    dropZoneBk.addEventListener('click', () => {
        importFileBk.click();
    });

    // Drag over
    dropZoneBk.addEventListener('dragover', (e) => {
        e.preventDefault();
        dropZoneBk.classList.add('border-blue-400', 'bg-blue-50');
    });

    // Drag leave
    dropZoneBk.addEventListener('dragleave', () => {
        dropZoneBk.classList.remove('border-blue-400', 'bg-blue-50');
    });

    // Drop file
    dropZoneBk.addEventListener('drop', (e) => {
        e.preventDefault();
        dropZoneBk.classList.remove('border-blue-400', 'bg-blue-50');

        const files = e.dataTransfer.files;
        if (files.length) {
            importFileBk.files = files;
            handleFileSelect(importFileBk);
        }
    });

    // File picker
    importFileBk.addEventListener('change', () => {
        handleFileSelect(importFileBk);
    });
</script>
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/guru_bk/modalExportImport.blade.php ENDPATH**/ ?>