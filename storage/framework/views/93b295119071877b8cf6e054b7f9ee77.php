<!-- Modal Edit -->
                        ...
                        <div>
                            ...
                            <select class="form-select w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent" id="edit_id_kelas" name="id_kelas" >
                                ...
                                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($k->id_kelas); ?>" <?php echo e(isset($walikelas->id_kelas) && $k->id_kelas == $walikelas->id_kelas ? 'selected' : ''); ?>>
    ...
    </div><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/walikelas/edit.blade.php ENDPATH**/ ?>