        ...
        <div class="mt-3">
            ...
            <div class="mt-4">
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <?php $__currentLoopData = $jurusanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurusan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jurusan); ?>" class="text-gray-900"><?php echo e($jurusan); ?></option>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option 
                                            value="<?php echo e($kelas->id_kelas); ?>" 
                                            data-jurusan="<?php echo e($kelas->jurusan); ?>"
                                            class="text-gray-900"
                                        >
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" 
                        action="<?php echo e(route('siswa.import')); ?>"
                        method="POST" 
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-3 border-t">
                                <a href="<?php echo e(asset('storage/template_siswa.xlsx')); ?>" download class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t mt-6">
                <button id="cancelExportImportBtn" type="button" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50">
                    Batal
                </button>
...
<script>
    ...
    document.getElementById('exportExcelBtn').addEventListener('click', () => {
        ...
        window.location.href = `<?php echo e(route('siswa.export.excel')); ?>?jurusan=${jurusan}&kelas=${kelas}`;
    });

    document.getElementById('exportPdfBtn').addEventListener('click', () => {
        const jurusan = document.getElementById('exportJurusan').value;
        const kelas   = document.getElementById('exportKelas').value;
        window.location.href = `<?php echo e(route('siswa.export.pdf')); ?>?jurusan=${jurusan}&kelas=${kelas}`;
    });
</script><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/siswa/modalExportImport.blade.php ENDPATH**/ ?>