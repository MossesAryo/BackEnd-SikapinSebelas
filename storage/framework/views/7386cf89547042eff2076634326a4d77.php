<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/wakasek/laporan_skoring.css')); ?>">
    <style>
        .dropdown-container {
            position: relative;
            width: 100%;
                            ...
                            <div id="kelasList"
                                ...
                                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="dropdown-item px-4 py-2 hover:bg-gray-100 cursor-pointer"
                                        data-value="<?php echo e($item->id_kelas); ?>">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-900">
                                        <?php echo e($kelas->first()->nama_kelas ?? '-'); ?>

                                    </p>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" id="kelas" name="kelas" value="<?php echo e($walikelasId); ?>">
                    <?php endif; ?>
                </div>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        function exportToPDF() {
            ...
            const url =
                `<?php echo e(route('laporan.export.pdf')); ?>?type=${reportType}&kelas=${kelas}&start_date=${startDate}&end_date=${endDate}`;
        ...
        function exportToExcel() {
            ...
            const endDate = document.getElementById('end_date').value;
            const url =
                `<?php echo e(route('laporan.export.excel')); ?>?type=${reportType}&kelas=${kelas}&start_date=${startDate}&end_date=${endDate}`;
            window.location.href = url;
        }
...
<?php echo $__env->make('layouts.wakasek.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/laporan/index.blade.php ENDPATH**/ ?>