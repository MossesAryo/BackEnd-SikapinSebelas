...
<div id="modal-filter" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full mx-4 transform transition-all">
        ...
        <!-- Form -->
        <form id="form-filter" method="GET" action="<?php echo e(route('kelas')); ?>">
            <div class="px-6 py-6 space-y-6">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <label class="flex items-center justify-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                            <input type="checkbox" name="tingkat[]" value="X" 
                                class="sr-only peer"
                                <?php echo e(in_array('X', request('tingkat', [])) ? 'checked' : ''); ?>>
                        ...
                        <label class="flex items-center justify-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                            <input type="checkbox" name="tingkat[]" value="XI" 
                                class="sr-only peer"
                                <?php echo e(in_array('XI', request('tingkat', [])) ? 'checked' : ''); ?>>
                            <div class="text-center peer-checked:text-blue-600 peer-checked:font-semibold">
                        ...
                        <label class="flex items-center justify-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                            <input type="checkbox" name="tingkat[]" value="XII" 
                                class="sr-only peer"
                                <?php echo e(in_array('XII', request('tingkat', [])) ? 'checked' : ''); ?>>
                            <div class="text-center peer-checked:text-blue-600 peer-checked:font-semibold">
                ...
                <div class="space-y-3">
                    ...
                    <select name="sort" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <option value="nama_kelas_asc" <?php echo e(request('sort') == 'nama_kelas_asc' ? 'selected' : ''); ?>>Nama Kelas (A-Z)</option>
                        <option value="nama_kelas_desc" <?php echo e(request('sort') == 'nama_kelas_desc' ? 'selected' : ''); ?>>Nama Kelas (Z-A)</option>
                        <option value="jurusan_asc" <?php echo e(request('sort') == 'jurusan_asc' ? 'selected' : ''); ?>>Jurusan (A-Z)</option>
                        <option value="jurusan_desc" <?php echo e(request('sort') == 'jurusan_desc' ? 'selected' : ''); ?>>Jurusan (Z-A)</option>
                        <option value="tingkat_asc" <?php echo e(request('sort') == 'tingkat_asc' ? 'selected' : ''); ?>>Tingkat (X, XI, XII)</option>
                        <option value="tingkat_desc" <?php echo e(request('sort') == 'tingkat_desc' ? 'selected' : ''); ?>>Tingkat (XII, XI, X)</option>
                    </select>
                </div>
...
function resetFilter() {
    ...
    window.location.href = "<?php echo e(route('kelas')); ?>";
}
...
</script><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/kelas/modalFilter.blade.php ENDPATH**/ ?>