...
<div id="modal-filter" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-[9999]" style="display: none;">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 relative">
        ...
        <!-- Form -->
        <form method="GET" action="<?php echo e(auth()->user()->role == 3 ? route('ketua_program.siswa') : route('siswa.index')); ?>" class="p-6 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <select id="jurusan" name="jurusan" class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:ring-4 focus:ring-blue-100 focus:border-blue-500">
                    ...
                    <?php $__currentLoopData = $jurusanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jurusan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($jurusan->id_jurusan); ?>" <?php echo e(request('jurusan') == $jurusan->id_jurusan ? 'selected' : ''); ?>>
                            <?php echo e($jurusan->id_jurusan); ?> 
                        </option>
            ...
            <div class="space-y-2">
                ...
                <select id="kelas" name="kelas" class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:ring-4 focus:ring-blue-100 focus:border-blue-500">
                    ...
                    <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <option value="<?php echo e($kelas->id_kelas); ?>" data-jurusan="<?php echo e($kelas->id_jurusan); ?>"
    ...
    <?php echo e($kelas->nama_kelas); ?>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t">
                ...
                <button type="button" onclick="window.location.href='<?php echo e(auth()->user()->role == 3 ? route('ketua_program.siswa') : route('siswa.index')); ?>'"
...
</script><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/siswa/filter.blade.php ENDPATH**/ ?>