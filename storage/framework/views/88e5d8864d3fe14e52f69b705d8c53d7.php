<div id="modal-create" class="fixed inset-0 bg-black bg-opacity-40 modal-overlay flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
        <form action="<?php echo e(route('skoring_penghargaan.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select id="nis" name="nis" required
                        ...
                        <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->nis); ?>"><?php echo e($item->nama_siswa); ?></option>
                ...
                <div>
                    ...
                    <select id="id_aspekpenilaian" name="id_aspekpenilaian" required
                        ...
                        <?php $__currentLoopData = $aspekPel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <input type="text" id="skor" name="skor"
                        value="<?php echo e($aspekPel->first()->indikator_poin ?? ''); ?>" readonly
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/skoring/penghargaan/create.blade.php ENDPATH**/ ?>