                                    ...
                                    <div class="px-4 py-3 bg-blue-50 border border-blue-200 rounded-lg">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-semibold text-gray-900"><?php echo e($kelas->first()->nama_kelas ?? '-'); ?></p>
                                                <p class="text-xs text-gray-500">Jurusan: <?php echo e($selectedJurusan ?? '-'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" id="export_jurusan" value="<?php echo e($selectedJurusan); ?>">
                                    <input type="hidden" id="export_kelas" value="<?php echo e($selectedKelas); ?>">
                                <?php else: ?>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Filter Jurusan (opsional)</label>
                                        <select id="export_jurusan" class="w-full mt-1 rounded-md border-gray-200 px-3 py-2" <?php if($userRole==3 && $selectedJurusan): ?> disabled <?php endif; ?>>
                                            <option value="">Semua Jurusan</option>
                                            <?php $__currentLoopData = $jurusanOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($jur); ?>" <?php echo e(($selectedJurusan ?? '') === $jur ? 'selected' : ''); ?>><?php echo e($jur); ?></option>
...
<script>
        function exportExcel() {
            const base = "<?php echo e(route('intervensi.export.excel')); ?>";
        ...
        function exportPdf() {
            const base = "<?php echo e(route('intervensi.export.pdf')); ?>";
            const params = new URLSearchParams(window.location.search);
            const kelas = document.getElementById('export_kelas')?.value || '';
            const status = document.getElementById('export_status')?.value || '';
            const jurusan = document.getElementById('export_jurusan')?.value || '';
        ...
        const kelasData = <?php echo json_encode($kelas->map(function($k){
    ...
    </script><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/intervensi/modalExportImport.blade.php ENDPATH**/ ?>