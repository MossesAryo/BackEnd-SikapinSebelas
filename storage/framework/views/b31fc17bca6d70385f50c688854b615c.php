     ...
     <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
         <div class="mt-3">
             ...
             <div class="flex items-center justify-between pb-3 border-b">
                 <h3 class="text-lg font-medium text-gray-900">Export Data Akumulasi</h3>
                 ...
                 <div id="exportContent" class="tab-content">
                     <div class="space-y-3">
                         <h4 class="text-sm font-medium text-gray-700 mb-3">Pilih format export:</h4>
                            ...
                            <button onclick="window.location='<?php echo e(route('akumulasi.export.excel', request()->query())); ?>'"
                            ...
                            <button onclick="window.location='<?php echo e(route('akumulasi.export.pdf', request()->query())); ?>'"
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/akumulasi/modalExportImport.blade.php ENDPATH**/ ?>