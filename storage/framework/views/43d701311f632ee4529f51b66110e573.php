    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="flex items-center justify-between pb-3 border-b">
                <h3 class="text-lg font-medium text-gray-900">Export/Import Data Penghargaan </h3>
            ...
            <div class="mt-4">
                ...
                <div id="exportContent" class="tab-content">
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='<?php echo e(route('penghargaan.export.excel')); ?>'"
                        ...
                        <button onclick="window.location='<?php echo e(route('penghargaan.export.pdf')); ?>'"
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" action="<?php echo e(route('penghargaan.import')); ?>" method="POST"
                        ...
                        <div class="space-y-4">
                            <div>
                                <h4 class="text-sm font-medium text-gray-700 mb-3">
                                    Upload file untuk import data:
                                </h4>

                                <!-- DROP ZONE -->
                                <div id="dropZonePenghargaan"
                                    ...
                                    <input type="file" name="file" id="importFilePenghargaan" class="hidden"
                                        accept=".xlsx,.xls,.csv">
                            ...
                            <div class="pt-3 border-t">
                                <a href="<?php echo e(asset('storage/template_penghargaan.xlsx')); ?>" download
...
<script>
    ...
    // Drag and Drop
    const dropZonePenghargaan = document.getElementById('dropZonePenghargaan');
    const importFilePenghargaan = document.getElementById('importFilePenghargaan');

    // Klik seluruh area
    dropZonePenghargaan.addEventListener('click', () => {
        importFilePenghargaan.click();
    });

    // Drag over
    dropZonePenghargaan.addEventListener('dragover', (e) => {
        e.preventDefault();
        dropZonePenghargaan.classList.add('border-blue-400', 'bg-blue-50');
    });

    // Drag leave
    dropZonePenghargaan.addEventListener('dragleave', () => {
        dropZonePenghargaan.classList.remove('border-blue-400', 'bg-blue-50');
    });

    // Drop
    dropZonePenghargaan.addEventListener('drop', (e) => {
        e.preventDefault();
        dropZonePenghargaan.classList.remove('border-blue-400', 'bg-blue-50');

        const files = e.dataTransfer.files;
        if (files.length) {
            importFilePenghargaan.files = files;
            handleFileSelect(importFilePenghargaan);
        }
    });

    // File picker
    importFilePenghargaan.addEventListener('change', () => {
        handleFileSelect(importFilePenghargaan);
    });
</script>
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/penghargaan/modalExportImport.blade.php ENDPATH**/ ?>