...
<div id="modal-create" class="fixed inset-0 bg-black bg-opacity-40 modal-overlay flex items-center justify-center hidden ">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
        <form action="<?php echo e(route('aspek_penghargaan.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-bold text-gray-700">Tambah Aspek Penghargaan</h2>
...
<?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/aspek_penilaian/aspek_penghargaan/create.blade.php ENDPATH**/ ?>