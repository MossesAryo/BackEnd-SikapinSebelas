                ...
                <h1 class="profile-name text-2xl font-semibold text-slate-800 mb-2">
                    <?php if(auth()->user()->role == 2): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <?php echo e(Auth::user()->gurubk->nama_guru_bk); ?>

                        <?php endif; ?>
                    <?php elseif(auth()->user()->role == 1): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <?php echo e(Auth::user()->wakasek->nama_wakasek); ?>

                        <?php endif; ?>
                    <?php elseif(auth()->user()->role == 4): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <?php echo e(Auth::user()->ketua_program->nama_ketua_program); ?>

                        <?php endif; ?>
                    <?php elseif(auth()->user()->role == 3): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <?php echo e(Auth::user()->walikelas->nama_walikelas); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                        ...
                        <div class="info-value text-sm font-medium text-slate-800">
                            <?php if(auth()->user()->role == 2): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php echo e(Auth::user()->gurubk->nip_bk); ?>

                                <?php endif; ?>
                            <?php elseif(auth()->user()->role == 1): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php echo e(Auth::user()->wakasek->nip_wakasek); ?>

                                <?php endif; ?>
                            <?php elseif(auth()->user()->role == 4): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php echo e(Auth::user()->ketua_program->nip_kaprog); ?>

                                <?php endif; ?>
                                <?php elseif(auth()->user()->role == 3): ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php echo e(Auth::user()->walikelas->nip_walikelas); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                        ...
                        <div class="info-value text-sm font-medium text-slate-800">
                            <?php echo e(Auth::user()->ketua_program->jurusan); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                        ...
                        <div class="info-value text-sm font-medium text-slate-800">
                            <?php echo e(Auth::user()->walikelas->id_kelas); ?>
...
<?php echo $__env->make('layouts.wakasek.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/profile/profilewakasek.blade.php ENDPATH**/ ?>