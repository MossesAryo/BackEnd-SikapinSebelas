        ...
        <form method="GET" class="p-6 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <select id="jurusan" name="jurusan" class="w-full rounded-xl border-2 border-gray-200 px-4 py-3 focus:ring-4 focus:ring-blue-100 focus:border-blue-500">
                    ...
                    <?php $__currentLoopData = $daftar_jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item); ?>" <?php echo e(request('jurusan') == $item ? 'selected' : ''); ?>>
                            <?php echo e($item); ?>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t">
                ...
                <button type="button" onclick="window.location.href='<?php echo e(route('kaprog.index')); ?>'"
...
</script><?php /**PATH D:\laragon\www\BackEnd-SikapinSebelas\resources\views/wakasek/kaprog/filter.blade.php ENDPATH**/ ?>