...
class KelasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['id_kelas' => 'X-BR-1', 'nama_kelas' => 'X BR 1', 'jurusan' => 'PM'],
            ['id_kelas' => 'X-BR-2', 'nama_kelas' => 'X BR 2', 'jurusan' => 'PM'],
            ['id_kelas' => 'X-BR-3', 'nama_kelas' => 'X BR 3', 'jurusan' => 'PM'],
            ...
            ['id_kelas' => 'X-MP-4', 'nama_kelas' => 'X MP 3', 'jurusan' => 'MP'],
