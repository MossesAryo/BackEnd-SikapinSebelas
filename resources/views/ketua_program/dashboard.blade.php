    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <a href="{{ route('aspek_penghargaan.index') }}" 
                ...
                <p class="text-sm font-medium text-green-800 group-hover:text-green-900">Aspek Penghargaan</p>
            </a>
            ...
            <a href="{{ route('aspek_pelanggaran.index') }}" 
                ...
                <p class="text-sm font-medium text-red-800 group-hover:text-red-900">Aspek Pelanggaran</p>
            </a>
