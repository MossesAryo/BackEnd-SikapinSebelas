                    ...
                    <div id="importContent" class="tab-content hidden">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-3 border-t">
                                <a href="{{ asset('storage/template_penghargaan.xlsx') }}" download class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
