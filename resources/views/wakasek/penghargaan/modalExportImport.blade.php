            ...
            <div class="mt-4">
                ...
                <div id="exportContent" class="tab-content">
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='{{ route('penghargaan.export.excel') }}'"
                        ...
                        <button onclick="window.location='{{ route('penghargaan.export.pdf') }}'"
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" action="{{ route('penghargaan.import') }}" method="POST"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-3 border-t">
                                <a href="{{ asset('storage/template_penghargaan.xlsx') }}" download
