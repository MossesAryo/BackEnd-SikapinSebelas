        ...
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <div class="flex items-center justify-between pb-3 border-b">
                    <h3 class="text-lg font-medium text-gray-900">Export/Import Data Pelanggaran </h3>
                ...
                <div class="mt-4">
                    ...
                    <div id="exportContent" class="tab-content">
                        <div class="space-y-3">
                            ...
                            <button
                            onclick="window.location='{{ route('peringatan.export.excel') }}'"
                            ...
                            <button 
                            onclick="window.location='{{ route('peringatan.export.pdf') }}'"
                    ...
                    <div id="importContent" class="tab-content hidden">
                        <form id="importForm" 
                        action="{{ route('peringatan.import') }}"
