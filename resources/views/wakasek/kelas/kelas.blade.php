        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <form id="form-delete" method="POST" class="p-8 space-y-6">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600 mb-1">Apakah Anda yakin ingin menghapus kelas</p>
                    <p class="font-semibold text-red-600 text-lg" id="delete-nama-kelas"></p>
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="bi bi-trash mr-2"></i>Hapus Kelas
                    </button>
                </div>
            </form>
        </div>
