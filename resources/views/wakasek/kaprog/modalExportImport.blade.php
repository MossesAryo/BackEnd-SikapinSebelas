            ...
            <div class="mt-4">
                ...
                <div id="exportContent" class="tab-content">
                    <div class="space-y-3">
                        ...
                        <button onclick="window.location='{{ route('ketua_program.export.excel') }}'"
                        ...
                        <button onclick="window.location='{{ route('ketua_program.export.pdf') }}'"
                ...
                <div id="importContent" class="tab-content hidden">
                    <form id="importForm" action="{{ route('ketua_program.import') }}" method="POST"
