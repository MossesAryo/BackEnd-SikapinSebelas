        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-lg">
            <form id="form-edit" method="POST" class="p-8 space-y-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold gradient-text">Edit Jurusan</h2>
                        <p class="text-gray-500 mt-1">Perbarui informasi jurusan yang dipilih</p>
                    </div>
                ...
                <div class="space-y-5">
                    <div>
                        <label for="edit_id_jurusan" class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="bi bi-hash mr-1"></i>ID Jurusan
                        </label>
                        <input type="text" id="edit_id_jurusan" name="id_jurusan"
                            class="form-input w-full px-4 py-3 rounded-xl border-2 border-gray-300 bg-gray-50 uppercase"
                            required>
                        <p class="text-xs text-gray-500 mt-1">ID jurusan tidak dapat diubah</p>
                    </div>

                    <div>
                        <label for="edit_nama_jurusan" class="block text-sm font-semibold text-gray-700 mb-2">
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <button type="submit" class="flex-1 btn-custom text-white py-3 rounded-xl font-medium">
                        <i class="bi bi-check-circle mr-2"></i>Update Jurusan
                    </button>
                </div>
            </form>
        </div>
