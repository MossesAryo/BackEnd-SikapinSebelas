    ...
    <div id="modal-create"
        ...
        <div class="modal-content bg-white rounded-2xl shadow-2xl w-full max-w-lg">
            <form action="{{ route('jurusan.store') }}" method="POST" class="p-8 space-y-6">
                @csrf
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold gradient-text">Tambah Jurusan Baru</h2>
                        <p class="text-gray-500 mt-1">Isi informasi jurusan yang akan ditambahkan</p>
                    </div>
                ...
                <div class="space-y-5">
                    <div>
                        <label for="id_jurusan" class="block text-sm font-semibold text-gray-700 mb-2">
                            <i class="bi bi-hash mr-1"></i>ID Jurusan
                        </label>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Gunakan format yang konsisten untuk ID jurusan</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Nama jurusan yang mudah dikenali</p>
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <button type="submit" class="flex-1 btn-custom text-white py-3 rounded-xl font-medium">
                        <i class="bi bi-check-circle mr-2"></i>Simpan Jurusan
                    </button>
                </div>
            </form>
        </div>
