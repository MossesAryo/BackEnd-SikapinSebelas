    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-xl mx-4">
        <form method="POST" class="p-6 space-y-4" id="edit_form-edit">
            ...
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-bold text-gray-700">Edit Aspek Pelanggaran</h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Pelanggaran Ke</label>
                    <select id="edit_pelanggaran_ke" name="pelanggaran_ke" required
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
