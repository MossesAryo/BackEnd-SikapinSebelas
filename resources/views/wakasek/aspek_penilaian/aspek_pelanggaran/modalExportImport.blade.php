        ...
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <div class="flex items-center justify-between pb-3 border-b">
                    <h3 class="text-lg font-medium text-gray-900">Export/Import Data Aspek Pelanggaran </h3>
                ...
                <div class="mt-4">
                    ...
                    <div id="exportContent" class="tab-content">
                        <div class="space-y-3">
                            ...
                            <button
                            onclick="window.location='{{ route('aspek_pelanggaran.export.excel') }}'"
                            ...
                            <button 
                            onclick="window.location='{{ route('aspek_pelanggaran.export.pdf') }}'"
                    ...
                    <div id="importContent" class="tab-content hidden">
                        <form id="importForm" 
                        action="{{ route('aspek_pelanggaran.import') }}"
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="border-2 border-dashed border-gray-300 round+ed-lg p-6 text-center hover:border-gray-400 transition-colors">
                                   {{-- TAMBAHKAN NAMA="FILE" BIAR MASUK DATA NYA KOCAK--}}
                            ...
                            <div class="pt-3 border-t">
                                <a href="{{ asset('storage/template_import-penghargaan.xlsx') }}" download class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
