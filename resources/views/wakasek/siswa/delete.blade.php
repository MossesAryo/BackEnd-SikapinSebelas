    ...
    <div id="modal-delete-peringatan" class="fixed inset-0 bg-black bg-opacity-40 modal-overlay flex items-center justify-center hidden">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md mx-4">
            <form id="form-delete-peringatan" method="POST" class="p-6 space-y-4">
                ...
                @method('DELETE')
                <div class="flex justify-between items-center">
                    <h2 class="text-xl font-bold text-gray-700">Hapus Peringatan</h2>
                    <button type="button" onclick="closeModal('modal-delete-peringatan')"
                        class="text-gray-500 hover:text-gray-700 text-xl">&times;</button>
                </div>
                <p class="text-gray-600">Apakah kamu yakin ingin menghapus Peringatan <span id="delete-nama-peringatan" class="font-semibold"></span>?</p>
                <div class="flex justify-end gap-2 pt-4">
                    <button type="button" onclick="closeModal('modal-delete-peringatan')"
                        class="px-4 py-2 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-100">Batal</button>
                    <button type="submit"
