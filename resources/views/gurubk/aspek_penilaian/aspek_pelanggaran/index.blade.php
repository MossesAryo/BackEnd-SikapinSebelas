        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border">
            <div class="flex flex-col md:flex-row gap-2 items-center justify-between">
                <div class="relative w-full md:w-64">
                    ...
                    <input type="text" placeholder="Cari Aspek Pelanggaran..."
...
@push('js')
    <script>
        ...
        function openEditModal(id, jenis, kategori, uraian, pelanggaran_ke, indikator_poin) {
            ...
            document.getElementById('edit_form-edit').action = `/aspek_pelanggaranbk/${id}/update`;
        ...
        function openDeleteModal(id) {
            ...
            document.getElementById('form-delete').action = `/aspek_pelanggaranbk/${id}/destroy`;
