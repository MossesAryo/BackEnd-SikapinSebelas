   ...
   <div class="max-w-6xl mx-auto p-8 space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm text-center h-full">
            ...
            <h1 class="profile-name text-2xl font-semibold text-slate-800 mb-2"> Evi S.pd</h1>
            <p class="profile-title text-blue-600 font-medium mb-6 text-sm">Guru Bimbingan Konseling (BK)</p>
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm h-full">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                    ...
                    <div class="info-value text-sm font-medium text-slate-800">Evi S.pd</div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                    ...
                    <div class="info-value text-sm font-medium text-slate-800">Evi@smkn1bandung.sch.id</div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-4 py-3 border-b border-slate-100">
                    <div class="text-sm font-medium text-slate-500">Jabatan</div>
                    <div class="info-value text-sm font-medium text-slate-800">Guru BK</div>
                </div>
        ...
        <div class="bg-white rounded-2xl p-8 w-full max-w-md mx-4 transform transition-all duration-300 scale-95 opacity-0"
            ...
            <form id="editForm" class="space-y-4">
                <div>
                    ...
                    <input type="text" id="namaLengkap" value="Evi S.pd"
                ...
                <div>
                    ...
                    <input type="email" id="email" value="evi@smkn1bandung.sch.id"
                        class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <select id="jabatan"
                        class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        <option value="Wakil Kepala Sekolah" selected>Guru</option>
